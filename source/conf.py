# -*- coding: utf-8 -*-
#
# MTH1001 in Lean configuration file, by Gihan Marasingha, based on that by
# Jeremy Avigad for "Theorem Proving in Lean".
#
...
project = u'MTH1001 in Lean'
copyright = u'2020, Gihan Marasingha'
author = u'Gihan Marasingha'
...
#    'logo_name': True,
   ...
   # 'code_bg': 'white',
    ...
    'extra_nav_links': {'Index': 'genindex.html',
                        'PDF version':'mth1001_in_lean.pdf',
...
htmlhelp_basename = 'mth1001_in_lean'
...
latex_documents = [
    (master_doc, 'mth1001_in_lean.tex', u'MTH1001 in Lean',
     u'Gihan Marasingha', 'manual'),
]
